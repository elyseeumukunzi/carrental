      ...
      <div class="container">
        <div class="user_profile_info gray-bg padding_4x4_40">
          ...
          <div class="dealer_info">
            ...
            <p>A tenant is a person who rents property from a lessor, on This carrental platform a lesse or tenant will
              pay the equivalent of $200 for running the platform <br> and be able to post his own car for renting
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" name="email" class="form-control white_bg" id="emailaddress"
                        value="<?php echo $result->EmailId; ?>" required>
                    </div>
                    <div class="form-group">
                      <label class="control-label">Phone Number <span>*</span></label>
                      <input type="text" name="phone" class="form-control white_bg" id="phonenumber" required
                        maxlength="10" pattern="[0-9]+" value="<?php echo $result->ContactNo; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <button class="btn" type="submit" name="apply" type="submit">Apply now <span class="angle_arrow"><i

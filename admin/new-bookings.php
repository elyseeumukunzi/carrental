				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							@$from = $_GET['from'];
							if ($from == 'tenant') { ?>
								<a href="new-bookings.php?from=tenant&id=<?php echo $_GET['id']; ?>"><button
										class="btn btn-primary">New</button></a>
								<a href="confirmed-bookings.php?from=tenant&id=<?php echo $_GET['id']; ?>"><button
										class="btn btn-primary">Comfirmed</button></a>
								<a href="canceled-bookings.php?from=tenant&id=<?php echo $_GET['id']; ?>"> <button
										class="btn btn-primary">Cancelled</button></a>
												...
												foreach ($results as $result) { ?>
													<tr>
														...
														<td>
															...
															if ($from == 'tenant') { ?>
															<a
																href="bookig-details.php?bid=<?php echo htmlentities($result->id); ?>&from=tenant&id=<?php echo $_GET['id']; ?>">
																View</a>

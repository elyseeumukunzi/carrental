...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="assets/images/wheels.png" alt="image">
      </div>
...
<li>
    <h4 style="color:red">Booking No #<?php echo htmlentities($result->BookingNumber); ?></h4>
                ...
                <div class="vehicle_title">
                  ...
                  <div style="float: left"><p><b>Contact Details for Support:</b> <?php echo htmlentities($result->message); ?> </p></div>
